[![Build Status](https://travis-ci.org/IgorZd/js-assignments.svg?branch=master)](https://travis-ci.org/IgorZd/js-assignments)
![Hackage-Deps](https://img.shields.io/hackage-deps/v/lens.svg)
[![Greenkeeper badge](https://badges.greenkeeper.io/IgorZd/js-assignments.svg)](https://greenkeeper.io/)
[![GitHub release](https://img.shields.io/github/release/IgorZd/js-assignments.svg)](https://github.com/it-shark-pro/js-assignments/releases/latest)
