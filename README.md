[![Build Status](https://travis-ci.org/Vight86/js-assignments.svg?branch=master)](https://travis-ci.org/Vight86/js-assignments)
![Hackage-Deps](https://img.shields.io/hackage-deps/v/lens.svg)
[![Greenkeeper badge](https://badges.greenkeeper.io/Vight86/js-assignments.svg)](https://greenkeeper.io/)
...
```
* Open https://github.com/Vight86/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/Vight86/js-assignments/builds).
